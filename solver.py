...
class Solver(object):
    ...
    def build_model(self, mode):
        ...
        if mode == 'train_TPN':
            ...
            self.g_scheduler = torch.scheduler.ReduceLROnPlateau(g_optimizer, 'min', patience=5, factor=0.1)
            self.d_scheduler = torch.scheduler.ReduceLROnPlateau(d_optimizer, 'min', patience=5, factor=0.1)
